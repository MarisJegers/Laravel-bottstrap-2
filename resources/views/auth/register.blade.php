...
<div class="container bg-secondary">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card m-5">
                <div class="card-header text-center border border-dark border-5"><h1>{{ __('Jauna lietotāja reģistrēšana') }}</h1></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Telefona Nr.') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="Darbu.vad">Darbu.vad</option>
                                <option value="Meistars">Meistars</option>
                                </select> 
